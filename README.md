...
- basic_term:
    Julia Benchmarks basic_term:
      minimum time: TrialEstimate(82.182 ms)
      result: 1.4489630534602132e7
  basic_term_array:
    Julia basic term array:
      minimum time: TrialEstimate(28.521 ms)
      result: 1.4489630534602132e7
- Python array numpy basic_term_m:
    minimum time: 86.30796500000315 milliseconds
    result: 14489630.534603368
  Python array pytorch basic_term_m:
    minimum time: 52.145306999989316 milliseconds
    result: 14489630.534603368
  Python lifelib basic_term_m:
    minimum time: 615.8642290000103 milliseconds
    result: 14489630.534601536
  Python recursive numpy basic_term_m:
    minimum time: 49.783083999983546 milliseconds
    result: 14489630.534603368
  Python recursive pytorch basic_term_m:
    minimum time: 76.96134700000812 milliseconds
    result: 14489630.53460337
exposures:
- Julia ExperienceAnalysis.jl:
    minimum time: TrialEstimate(29.227 ms)
    num_rows: 141281
- R actxps:
    min: 490.714363 ms
    num_rows: 141281
...
- Julia MortalityTables.jl:
    minimum time: TrialEstimate(230.188 μs)
    result: 1904.4865526636793
- Python PyMort:
    minimum time: 9.051531000011437 milliseconds
    result: 1904.4865526636793
savings_benchmark:
- Julia Benchmarks savings:
    minimum time: TrialEstimate(119.065 ms)
    result: 3.507113709040273e12
- Python lifelib cashvalue_me_ex4:
    minimum time: 585.1654649999887 milliseconds
