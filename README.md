...
- basic_term:
    Julia Benchmarks basic_term:
      minimum time: TrialEstimate(84.971 ms)
      result: 1.4489630534602132e7
  basic_term_array:
    Julia basic term array:
      minimum time: TrialEstimate(50.032 ms)
      result: 1.4489630534602132e7
- Python array numpy basic_term_m:
    minimum time: 78.78100400000676 milliseconds
    result: 14489630.534603368
  Python array pytorch basic_term_m:
    minimum time: 46.044203999997535 milliseconds
    result: 14489630.534603368
  Python lifelib basic_term_m:
    minimum time: 617.2145910000211 milliseconds
    result: 14489630.534601536
  Python recursive numpy basic_term_m:
    minimum time: 46.96940000002314 milliseconds
    result: 14489630.534603368
  Python recursive pytorch basic_term_m:
    minimum time: 73.11199500000498 milliseconds
    result: 14489630.53460337
exposures:
- Julia ExperienceAnalysis.jl:
    minimum time: TrialEstimate(29.502 ms)
    num_rows: 141281
- R actxps:
    min: 491.00715 ms
    num_rows: 141281
...
- Julia MortalityTables.jl:
    minimum time: TrialEstimate(229.638 μs)
    result: 1904.4865526636793
- Python PyMort:
    minimum time: 9.18133299998658 milliseconds
    result: 1904.4865526636793
savings_benchmark:
- Julia Benchmarks savings:
    minimum time: TrialEstimate(118.386 ms)
    result: 3.507113709040273e12
- Python lifelib cashvalue_me_ex4:
    minimum time: 560.7893039999965 milliseconds
