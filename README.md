...
- Julia MortalityTables.jl:
    minimum time: TrialEstimate(229.669 μs)
    result: 1904.4865526636793
- Python PyMort:
    minimum time: 9.118037999996886 milliseconds
    result: 1904.4865526636793
savings_benchmark:
- Julia Benchmarks savings:
    minimum time: TrialEstimate(118.923 ms)
    result: 3.507113709040273e12
- Python lifelib cashvalue_me_ex4:
    minimum time: 588.568204000012 milliseconds
